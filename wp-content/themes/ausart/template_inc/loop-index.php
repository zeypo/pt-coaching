	...
	while (have_posts()) : the_post();
        ...
        <article id="post-<?php echo the_ID(); ?>" <?php echo post_class('blog-article '.$extra_cl.' v1 normal'); ?>>                    
                        ...
                        <?php $slider = new themeple_slideshow(get_the_ID(), 'flexslider');
                            ...
                            <div class="quote_box">
                             ...
                             <div class="information">
                                <span><i class="moon-user"></i><?php _e('Posted by', 'themeple') ?> <?php echo get_the_author() ?>  <?php the_time('d') ?> <?php the_time('M') ?></span>                   
                                <span><i class="moon-tag"></i><?php echo esc_attr($count) ?> <?php _e('Comments', 'themeple') ?></span> 
                              
                                <?php if(!empty($tag_out) ): ?>
                                         <li><i class="moon-tag"></i><?php echo esc_attr($tag_out) ?></li>
                                 <?php endif; ?>              
                             <?php  } ?>    
            ...
            <dl class="dl-horizontal">             
                ...
                <dt><div class="dt"><span class="date"><?php the_time('d') ?></span><span class="month"><?php the_time('F') ?></span></div><div class="icon_"><i class="moon-<?php echo esc_attr($icon_class) ?>"></i></div></dt>
                ...
                <dd>
                    ...
                    <div class="blog-content">        
                                    ...
                                    <div class="information">
                                        ...
                                        <span><i class="moon-user"></i><?php _e('Posted by', 'themeple') ?> <?php echo get_the_author() ?>&nbsp; <i class="moon-calendar"></i> <?php _e('Posted on', 'themeple') ?>  <?php the_time('d') ?> <?php the_time('M') ?></span>&nbsp; <li class="tags pull-right"><i class="moon-tag"></i><?php echo esc_attr($tag_out) ?></li>
                            ...
                            <?php if(!is_single() && $post_format != 'quote' ): ?>
                                 <ul class="info">
                                    ...
                                    <?php if(!empty($tag_out) ): ?>
                                         <li class="tags"><i class="moon-tag"></i><?php echo esc_attr($tag_out) ?></li>
                                    <?php endif; ?>
